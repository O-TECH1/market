...
<div class="collapse navbar-collapse" id="navbarSupportedContent">
  <ul class="nav navbar-nav menu">
    ...
    <li class="nav-item">
      <a class="nav-link active" href="myproduct.php">My Products</a>
    </li>
    <li class="nav-item">
...
<div class="container-fluid">
  <div class="row-fluid">
    <div class="col-md-12">
      <h2><i class="glyphicon glyphicon-user"></i> My Products </h2>
    </div>   
    <div class="col-md-12">
    ...
    <div class="row">
      <div class="col-md-10" style="min-width: 90%">
        ...
        if (isset($_SESSION['user_id'])) {
          ...
          $pQuery = mysqli_query($con,"SELECT * FROM products WHERE owner = '$key'");
